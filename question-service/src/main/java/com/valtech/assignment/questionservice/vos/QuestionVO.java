...
public record QuestionVO(String questionText, String option1, String option2, String option3, String option4,
		String correctOption, String topic) {
	
	public static QuestionVO from(Question question) {
	
		return new QuestionVO(question.getQuestionText(), question.getOption1(), 
